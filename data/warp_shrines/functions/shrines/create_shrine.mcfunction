...
# Cool visual and audio effects when thrown if mobs are enabled
...
execute at @e[tag=ws_shrine,limit=1,sort=nearest] unless score $ws_mobs ws_mobs matches ..0 run summon phantom ~ ~30 ~ {Tags:["ws_warpMob"],CustomName:"\"Warp Stalker\"",ActiveEffects:[{Id:12,Amplifier:0,Duration:300,ShowParticles:0b}],Passengers:[{Tags:["ws_warpMob"],id:"vex",CustomName:"\"Warp-Twisted Keeper\""}]}
execute at @e[tag=ws_shrine,limit=1,sort=nearest] unless score $ws_mobs ws_mobs matches ..0 run summon phantom ~ ~30 ~ {Tags:["ws_warpMob"],CustomName:"\"Warp Stalker\"",ActiveEffects:[{Id:12,Amplifier:0,Duration:300,ShowParticles:0b}],Passengers:[{Tags:["ws_warpMob"],id:"vex",CustomName:"\"Warp-Twisted Keeper\""}]}
execute at @e[tag=ws_shrine,limit=1,sort=nearest] unless score $ws_mobs ws_mobs matches ..0 run summon phantom ~ ~30 ~ {Tags:["ws_warpMob"],CustomName:"\"Warp Stalker\"",ActiveEffects:[{Id:12,Amplifier:0,Duration:300,ShowParticles:0b}],Passengers:[{Tags:["ws_warpMob"],id:"vex",CustomName:"\"Warp-Twisted Keeper\""}]}
execute at @e[tag=ws_shrine,limit=1,sort=nearest] unless score $ws_mobs ws_mobs matches ..0 run summon phantom ~ ~30 ~ {Tags:["ws_warpMob"],CustomName:"\"Alpha Warp Stalker\"",ActiveEffects:[{Id:11,Amplifier:2,Duration:300,ShowParticles:0b},{Id:12,Amplifier:0,Duration:300,ShowParticles:0b}],Size:15}
